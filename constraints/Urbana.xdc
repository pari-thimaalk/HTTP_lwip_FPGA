...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets phy_clk_IBUF]
...
# On-board Buttons
#set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS25} [get_ports {sys_rst}]
...
# PMOD B Signals
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports {txd[0]}]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports {rxd[1]}]
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports {crs}]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports {mdio_rtl_0_mdc}]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports {tx_en}]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {rxd[0]}]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports {phy_clk}]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33} [get_ports {mdio_rtl_0_mdio_io}]
...
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports {txd[1]}]
