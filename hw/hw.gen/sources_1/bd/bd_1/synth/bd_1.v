...
(* CORE_GENERATION_INFO = "bd_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=14,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "bd_1.hwdef" *) 
module bd_1
   (clk_100mhz,
    ddr3_addr,
    ddr3_ba,
    ...
    uart_rxd,
    uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_100MHZ CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_100MHZ, CLK_DOMAIN bd_1_clk_100mhz, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_100mhz;
  ...
  bd_1_axi_uartlite_0_0 axi_uartlite_0
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_1 microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_1_microblaze_0_0 microblaze_0
  ...
  microblaze_0_local_memory_imp_10OYFK7 microblaze_0_local_memory
  ...
  bd_1_mig_7series_0_0 mig_7series_0
  ...
  bd_1_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
  ...
  bd_1_rst_mig_7series_0_166M_0 rst_mig_7series_0_166M
       (.aux_reset_in(1'b1),
...
module microblaze_0_local_memory_imp_10OYFK7
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > bd_1 microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_1_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  bd_1_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  bd_1_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
