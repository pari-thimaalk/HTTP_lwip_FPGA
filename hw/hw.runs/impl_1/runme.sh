...
HD_PWD='C:/Users/aadit/Documents/ECE_385/385group/Final_proj/final_proj_new/hw/hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_eth_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_eth_top.tcl -notrace
