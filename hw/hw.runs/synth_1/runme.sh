...
HD_PWD='C:/Users/aadit/Documents/ECE_385/385group/Final_proj/final_proj_new/hw/hw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_eth_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_eth_top.tcl
