...
HD_PWD='C:/Users/aadit/Documents/ECE_385/385group/Final_proj/final_proj_new/hw/hw.runs/bd_hdmi_text_controller_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_hdmi_text_controller_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_hdmi_text_controller_0_1.tcl
